"""
Alembic env.py — suporte async (aiosqlite / asyncpg).
A URL do banco é lida de DATABASE_URL (variável de ambiente).
...
# Sobrescrever URL com variável de ambiente (RNF-6)
...
async def run_async_migrations() -> None:
    """Executa migrações em modo 'online' com engine async."""
